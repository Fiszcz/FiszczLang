            ...
            ((_la & ~0x1f) == 0 &&
                ((1 << _la) &
                    ((1 << FiszczLangParser.T__1) |
                        ...
                        (1 << FiszczLangParser.T__11) |
                        (1 << FiszczLangParser.T__12) |
    ...
    try {
        ...
        if (
            !(
                ((_la - 30) & ~0x1f) == 0 &&
                ((1 << (_la - 30)) &
                    ((1 << (FiszczLangParser.EQUAL - 30)) |
                        (1 << (FiszczLangParser.LESS_OR_EQUAL - 30)) |
                        (1 << (FiszczLangParser.GREATER_OR_EQUAL - 30)) |
                        (1 << (FiszczLangParser.GREATER_THAN - 30)) |
                        (1 << (FiszczLangParser.LESS_THAN - 30)))) !==
                    0
            )
        ) {
            this._errHandler.recoverInline(this);
