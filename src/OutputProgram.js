...
var OutputProgram = /** @class */ (function () {
    ...
    OutputProgram.prototype.writeToFile = function () {
        ...
        this.stringConstants.forEach(function (stringConstant, index) { return outputProgram += outputLLVMInstructions_1.createStringConstant(index + 1, getLengthOfString(stringConstant), stringConstant) + '\n'; });
    ...
    OutputProgram.prototype.createStringVariable = function (name, type, value) {
        ...
        this.addLineOfIR(outputLLVMInstructions_1.createVariableDefinition(name, 'i8*', "getelementptr inbounds ([" + (lengthOfText + 1) + " x i8], [" + (lengthOfText + 1) + " x i8]* @.str." + stringConstantId + ", i64 0, i64 0)", 8));
    ...
    OutputProgram.prototype.createNumericArray = function (name, type, value) {
        this.addLineOfIR(outputLLVMInstructions_1.createVariableDefinition(name, type, "[" + value.map(function (valueOfElement) { return 'i32 ' + valueOfElement; }).join(',') + "]", 4));
    ...
    OutputProgram.prototype.assignmentToArrayElement = function (variableName, elementNumber, newValue) {
        ...
        this.addLineOfIR(outputLLVMInstructions_1.store(regIdOfGetElement, variable.basicType, newValue.value, getAlign(variable.basicType)));
    };
        ...
        switch (valueToPrint.typeOfValue) {
            case 'variable': {
                ...
                if (variable.type === 'i8*') {
                    ...
                    this.addLineOfIR(outputLLVMInstructions_1.print(this.getNextRegId(), getInputOutputStringType(variable.type, variable.value), variable.type, '%' + regIdWithValueToPrint));
                }
                else {
                    var regIdWithValueToPrint = this.loadOperation(variable);
                    this.addLineOfIR(outputLLVMInstructions_1.print(this.getNextRegId(), getInputOutputStringType(variable.type), variable.type, '%' + regIdWithValueToPrint));
                }
                break;
            }
            case 'i32': {
                this.addLineOfIR(outputLLVMInstructions_1.print(this.getNextRegId(), getInputOutputStringType(valueToPrint.typeOfValue), valueToPrint.typeOfValue, valueToPrint.value));
                break;
            }
            case 'double': {
                this.addLineOfIR(outputLLVMInstructions_1.print(this.getNextRegId(), getInputOutputStringType(valueToPrint.typeOfValue), valueToPrint.typeOfValue, valueToPrint.value));
            ...
            case 'i8*': {
                ...
                this.addLineOfIR(outputLLVMInstructions_1.printString(this.getNextRegId(), getLengthOfString(valueToPrint.value), stringConstantId));
                break;
            }
            case 'arrayVariable': {
                ...
                this.addLineOfIR(outputLLVMInstructions_1.print(this.getNextRegId(), getInputOutputStringType(variable.basicType), variable.basicType, '%' + elementRegId));
                break;
            }
        }
    };
    OutputProgram.prototype.readValue = function (variableName) {
        var variable = this.getVariable(variableName);
        this.addLineOfIR(outputLLVMInstructions_1.read(this.getNextRegId(), getInputOutputStringType(variable.type), variable.type, variableName));
    };
    OutputProgram.prototype.startWhile = function (conditionElements) {
        ...
        var leftSideOfOperator = conditionElements.leftSideOfOperator, rightSideOfOperator = conditionElements.rightSideOfOperator, comparisonType = conditionElements.comparisonType;
        ...
        return { lineOfIRToEditAfterEndOfIf: lineOfIRToEditAfterEndOfIf, labelOfCondition: labelOfCondition, labelOfWhileBody: labelOfWhileBody, comparisonResult: comparisonResult };
    };
    OutputProgram.prototype.endWhile = function (_a) {
        var lineOfIRToEditAfterEndOfIf = _a.lineOfIRToEditAfterEndOfIf, labelOfCondition = _a.labelOfCondition, labelOfWhileBody = _a.labelOfWhileBody, comparisonResult = _a.comparisonResult;
        ...
        this.instructions[lineOfIRToEditAfterEndOfIf] = outputLLVMInstructions_1.ifInstruction(comparisonResult, labelOfWhileBody, labelAfterWhile);
    };
    ...
    OutputProgram.prototype.makeComparison = function (firstElement, secondElement, typeOfComparison) {
        ...
        if (firstElement.typeOfValue === 'i32' && secondElement.typeOfValue === 'i32') {
            this.addLineOfIR(outputLLVMInstructions_1.comparison(comparisonRegId, getTypeOfComparisonForType(typeOfComparison, 'i32'), 'i32', firstElement.value, secondElement.value));
        }
            ...
            this.addLineOfIR(outputLLVMInstructions_1.comparison(comparisonRegId, getTypeOfComparisonForType(typeOfComparison, 'double'), 'double', convertedToDouble, secondElement.value));
        }
            ...
            this.addLineOfIR(outputLLVMInstructions_1.comparison(comparisonRegId, getTypeOfComparisonForType(typeOfComparison, 'double'), 'double', firstElement.value, convertedToDouble));
        }
        else {
            this.addLineOfIR(outputLLVMInstructions_1.comparison(comparisonRegId, getTypeOfComparisonForType(typeOfComparison, 'double'), 'double', firstElement.value, secondElement.value));
        }
